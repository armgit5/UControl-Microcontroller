...
// VegaSwing 61 a vibration sensor, takes a sample, and send out the 
...
void main()
{
     unsigned char phone_num[]="316XXXXXXX",msg1[]="XX XXXXX",msg2[]="XXXX";
     unsigned char msg3[]="XXXX";
     double current;
     int i;
     ...
     while(1)
     {
        ...
        Delay_ml(120000);        //Delay of 15mS for stability of the input.
